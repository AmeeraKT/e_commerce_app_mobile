...
import 'package:e_commerce_app_mobile/widgets/product_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  final List<ItemHomepage> items = [
      ItemHomepage("View Cookie List", Icons.shopping_cart, Colors.deepPurple[600]!),
      ItemHomepage("Add Cookie", Icons.add,  Colors.blue[600]!),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // The title of the application "E-Commerce App" with white text and bold font.
        title: const Text(
          'Cookie Panda - E-Commerce App',
            style: TextStyle(
            color: Colors.white,
